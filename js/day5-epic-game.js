...
const CONFIG = {
    ...
    /*
       IMPORTANT:
       Day 5 goes to Day 6 VIDEO first.
    */
...
function tryInteract() {
    ...
    /*
       IMPORTANT:
       The portal no longer automatically
       sends the player to Day 6.

       If the player presses F near the portal,
       we only show the victory instruction.
    */
    ...
    if (
        ...
        if (
            ...
            showNotification(
                "Continue from the Victory screen!"
            );
        }
    }
}
...
function bossDefeated() {
    ...
    /*
       Portal opens after the boss death.
    */
    ...
    /*
       Victory screen appears after
       the boss death sequence.
    */
...
/*
   Portal click does NOT automatically redirect.
   The player must finish Day 5 and press CONTINUE.
*/
...
function updatePortalProximity() {
    ...
    /*
       ...
       Previously this code caused Day 6 to open
       immediately when the player walked close
       to the portal.

       Now the player must press CONTINUE.
    */
    ...
    if (
        ...
        /*
           Do not hide the lantern prompt if
           another lantern is nearby.
        */
...
function winGame() {
    ...
    */
    ...
    /*
       Make sure victory screen is visible.
    */
    ...
    /*
       Make sure Continue is visible/clickable.
    */
